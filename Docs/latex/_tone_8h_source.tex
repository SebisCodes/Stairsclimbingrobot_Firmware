...
\DoxyCodeLine{13     \mbox{\hyperlink{class_tone}{Tone}}(PinName dacPin);}
\DoxyCodeLine{14     \mbox{\hyperlink{class_tone}{\string~Tone}}();}
\DoxyCodeLine{15     }
...
\DoxyCodeLine{20     \textcolor{keywordtype}{void} play(\textcolor{keyword}{const} \textcolor{keywordtype}{float} frequency,\textcolor{keyword}{const} \textcolor{keywordtype}{float} duration);}
\DoxyCodeLine{21     }
\DoxyCodeLine{22     \textcolor{comment}{// play array of notes and duration, must send length and beats per minute}}
\DoxyCodeLine{23     \textcolor{keywordtype}{void} play\_melody(\textcolor{keywordtype}{int} length,\textcolor{keyword}{const} \textcolor{keywordtype}{int} *notes,\textcolor{keyword}{const} \textcolor{keywordtype}{int} *durations,\textcolor{keywordtype}{float} bpm,\textcolor{keywordtype}{bool} repeat);}
\DoxyCodeLine{24     }
\DoxyCodeLine{25     \textcolor{comment}{// change the BPM}}
\DoxyCodeLine{26     \textcolor{keywordtype}{void} set\_bpm(\textcolor{keywordtype}{float} bpm);}
\DoxyCodeLine{27      }
